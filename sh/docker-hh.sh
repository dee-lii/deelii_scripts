...
#解压缩
unzip -o Portainer-CN.zip -d /root/docker/public >>  portainerSetup.log
echo  "---------------->解压缩portainer汉化包到/public成功<------------------"
successOf
#启动命令
docker run -d -p 9000:9000 --restart=always  -v /var/run/docker.sock:/var/run/docker.sock -v portainer_data:/data -v /root/docker/public:/public --name prtainer-test  portainer/portainer >>  portainerSetup.log
successOf
